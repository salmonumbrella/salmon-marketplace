...
var NotionAction = /* @__PURE__ */ ((NotionAction2) => {
  ...
  NotionAction2["UPDATE_DATABASE"] = "update_database";
  NotionAction2["GET_DATABASE"] = "get_database";
  NotionAction2["CREATE_PAGE"] = "create_page";
  NotionAction2["GET_PAGE"] = "get_page";
  NotionAction2["UPDATE_PAGE"] = "update_page";
  NotionAction2["GET_PAGE_PROPERTY"] = "get_page_property";
  NotionAction2["GET_BLOCK_CHILDREN"] = "get_block_children";
  NotionAction2["APPEND_BLOCK_CHILDREN"] = "append_block_children";
  NotionAction2["GET_BLOCK"] = "get_block";
  NotionAction2["UPDATE_BLOCK"] = "update_block";
  NotionAction2["DELETE_BLOCK"] = "delete_block";
  NotionAction2["GET_USER"] = "get_user";
  NotionAction2["LIST_USERS"] = "list_users";
  NotionAction2["GET_SELF"] = "get_self";
  NotionAction2["GET_COMMENTS"] = "get_comments";
  NotionAction2["CREATE_COMMENT"] = "create_comment";
  NotionAction2["SEARCH"] = "search";
  return NotionAction2;
})(NotionAction || {});
var UseNotionParams = {
  action: external_exports.nativeEnum(NotionAction).describe("Action to perform"),
  database_id: external_exports.string().optional().describe("Database ID"),
  page_id: external_exports.string().optional().describe("Page ID"),
  block_id: external_exports.string().optional().describe("Block ID"),
  user_id: external_exports.string().optional().describe("User ID"),
  property_id: external_exports.string().optional().describe("Property ID"),
  title: external_exports.string().optional().describe("Title/name"),
  properties: external_exports.record(external_exports.any()).optional().describe("Properties object"),
  children: external_exports.array(external_exports.any()).optional().describe("Block children array"),
  content: external_exports.string().optional().describe("Text content (converted to paragraph block)"),
  parent: external_exports.record(external_exports.any()).optional().describe("Parent reference {database_id: ...} or {page_id: ...}"),
  query: external_exports.string().optional().describe("Search/filter query"),
  filter: external_exports.record(external_exports.any()).optional().describe("Database filter object"),
  sorts: external_exports.array(external_exports.any()).optional().describe("Sort array"),
...
Pattern 1 interface: single tool with action parameter. Supports all Notion API operations.`,
  ...
  async (args) => {
    try {
      const params = external_exports.object(UseNotionParams).parse(args);
